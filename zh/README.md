...
相较于直接依赖 `LeviLamina` 的插件，我们有一个表格用来对比：
...
3. 在 Komomo 的 [Releases](https://github.com/LiteLDev/Komomo/releases) 界面下载并最新版的 Komomo。
4. 以同样的方式安装依赖于 Komomo 的脚本插件。
5. 启动服务器！你将会看到 Komomo 和脚本插件被顺利加载。
